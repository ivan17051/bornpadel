...
INSERT INTO `migrations` VALUES (13, '2024_01_04_000001_create_turnamen_peserta_table', 4);
INSERT INTO `migrations` VALUES (14, '2024_01_05_000001_migrate_pemain_foto_to_public', 5);
...
-- Records of pemain
-- ----------------------------
INSERT INTO `pemain` VALUES (1, 'Andi Wijaya', '1995-03-12', 31, 'male', '081234567801', 4.50, NULL, '2026-06-10 09:33:04', '2026-06-10 09:33:04');
INSERT INTO `pemain` VALUES (2, 'Budi Santoso', '1992-07-25', 33, 'male', '081234567802', 4.20, NULL, '2026-06-10 09:33:04', '2026-06-10 09:33:04');
INSERT INTO `pemain` VALUES (3, 'Citra Dewi', '1998-11-08', 27, 'female', '081234567803', 3.80, NULL, '2026-06-10 09:33:04', '2026-06-10 09:33:04');
INSERT INTO `pemain` VALUES (4, 'Dian Pratama', '1990-01-30', 36, 'male', '081234567804', 5.00, NULL, '2026-06-10 09:33:04', '2026-06-10 09:33:04');
INSERT INTO `pemain` VALUES (5, 'Eka Putri', '1999-05-17', 27, 'female', '081234567805', 3.50, NULL, '2026-06-10 09:33:04', '2026-06-10 09:33:04');
INSERT INTO `pemain` VALUES (6, 'Fajar Nugroho', '1994-09-03', 31, 'male', '081234567806', 4.00, NULL, '2026-06-10 09:33:04', '2026-06-10 09:33:04');
INSERT INTO `pemain` VALUES (7, 'Gita Rahayu', '2000-12-22', 25, 'female', '081234567807', 3.20, NULL, '2026-06-10 09:33:04', '2026-06-10 10:11:03');
INSERT INTO `pemain` VALUES (8, 'Hendra Kusuma', '1988-06-14', 37, 'male', '081234567808', 4.80, NULL, '2026-06-10 09:33:04', '2026-06-10 09:33:04');
INSERT INTO `pemain` VALUES (9, 'Coba', '2000-01-01', 26, 'male', '08189213123', 3.00, 'img/pemain/pemain_6a2a75a0021437.69021568.webp', '2026-06-11 08:45:20', '2026-06-11 08:56:07');
...
INSERT INTO `turnamen` VALUES (2, 'Born Padel Club Championship', 150000.00, 'Terbuka untuk member aktif Born Padel Club.', 'draft', '2026-06-10 09:33:04', '2026-06-11 09:49:38');
INSERT INTO `turnamen` VALUES (3, 'Padel Turnamen 2026', 0.00, 'Syarat 1', 'open', '2026-06-11 02:44:47', '2026-06-11 09:49:38');
...
CREATE TABLE `turnamen_peserta`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `turnamen_peserta_id_turnamen_id_pemain_unique`(`id_turnamen` ASC, `id_pemain` ASC) USING BTREE,
  INDEX `turnamen_peserta_id_pemain_foreign`(`id_pemain` ASC) USING BTREE,
  CONSTRAINT `turnamen_peserta_id_pemain_foreign` FOREIGN KEY (`id_pemain`) REFERENCES `pemain` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `turnamen_peserta_id_turnamen_foreign` FOREIGN KEY (`id_turnamen`) REFERENCES `turnamen` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of turnamen_peserta
-- ----------------------------
INSERT INTO `turnamen_peserta` VALUES (1, 3, 1, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (2, 3, 2, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (3, 3, 3, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (4, 3, 4, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (5, 3, 5, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (6, 3, 6, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (7, 3, 7, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (8, 3, 8, 'approved', '2026-06-11 06:19:34', '2026-06-11 06:19:34');
INSERT INTO `turnamen_peserta` VALUES (9, 2, 9, 'pending', '2026-06-11 08:45:20', '2026-06-11 08:45:20');
INSERT INTO `turnamen_peserta` VALUES (10, 3, 9, 'rejected', '2026-06-11 09:52:01', '2026-06-11 09:52:29');
